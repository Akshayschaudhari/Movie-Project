...
const MovieRevenue = () => {
    ...
    function GetRevenueMovie() {
        ...
        if (selectedMovie.length === 0  && selectedMovie === "Select Movie") {
            ...
            axios
                .post(
                    config.serverURL+"/admin/revenue",{Id},
                    {
                        headers: {
                            token: sessionStorage.token,
                        },
    ...
    return (
        sessionStorage.role === "Admin" && <div className="container-fluid" style={{ paddingTop: 0, top: 0, marginLeft: 0, height: "100%", paddingLeft: 0, width: "100%", display: "flex" }}>
            ...
            <div className="container" style={{ top: 0, width: "85%", marginRight: 0 }}>
                <h3 style={{ textAlign: "center", marginTop: 30, zIndex: 1 }}>Movie Revenue Statistics</h3>
                <div className="row">
                    ...
                    <div className="col-6">
                        <div className="form">
                            <div className="mb-3">
                                ...
                                <br></br>
                                <select style={{ padding: "0.3rem", marginTop: "1rem" }} onChange={(event) => {
                                    setRevenueobj(-1)
                ...
                {revenueobj !==-1 && <div style={{ marginTop : "2rem" }}>
                   <h1>Total Collection of {selectedMovie} is {revenueobj} RS/-</h1> 
                </div>}
                </div>
            </div>
        </div>
